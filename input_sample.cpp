...
int main() {
    ...
    cin >> a;
    cout << a << endl;
    // вы можете заметить, что стрелочки у cin и cout направлены в разные стороны. Это легко запомнить:
    // куда идут данные - в ту сторону ставим стрелки. В cin данные переходят из входного потока в переменную,
    // стрелки направлены к переменной; в cout данные идут из переменной в консоль, стрелки в сторону cout
